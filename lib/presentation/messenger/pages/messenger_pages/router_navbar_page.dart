...
class _RouterNavbarPageState extends State<RouterNavbarPage> {
  ...
  initState() {
    ...
    box.put(
      "userToken",
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1laWQiOiI3N2ExNmMwNy0yYmJhLTQ3MDYtZDA1OS0wOGRkMmNjNTIxZDEiLCJ1bmlxdWVfbmFtZSI6IjA5MDAwMDAwMDAxIiwibmJmIjoxNzQ1NDk3ODQyLCJleHAiOjE3NDU1MDU2NDIsImlhdCI6MTc0NTQ5Nzg0MiwiaXNzIjoiWW91ckFQSSIsImF1ZCI6IllvdXJBUElVc2VycyJ9.Vp8w2ULMP4rf9PHeRnlpPQWEiHtSwy0VQOsipU5rH3E",
    );
    box.put("userType", 2);
